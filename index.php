...
<head>
    ...
    <title>VIVID FLOW- Srilanka</title>
    <!-- Bootstrap core CSS -->
...
<body class="home">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php"><i><b>Home</b></i><span class="sr-only">(current)</span></a> </li>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/home.webp">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1> BURSTING WITH COLORS </h1>
                    <h5 class="font-white space-xs"><i> HUGE RANGE OF COLORS AND FINISHES </i></h5>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Color</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Order Color</h4> </div>
                        <!-- end:Step -->
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2><b><u>Popular Colors of the Year</u></b></h2>
                    <p class="lead"><i>The Easiest Way To Your Favourite Color</i></p>
                </div>
                <div class="row">
						...
						<?php 
						// fetch records from database to display popular first 3 colors from table
									      ...
									      while($r=mysqli_fetch_array($query_res))
										  {
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															<div class="figure-wrap bg-image" data-image-src="admin/Res_img/colors/'.$r['image'].'">
																
																<div class="rating pull-left"> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star-o"></i> </div>
																
															</div>
															<div class="content">
																<h5><a href="cart.php?res_id='.$r['rs_id'].'">'.$r['title'].'</a></h5>
																<div class="product-name">'.$r['des'].'</div>
																<div class="price-btn-block"><a href="cart.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>
                                                                <!-- <div class="price-btn-block"> <span class="price">LKR '.$r['price'].'/1 Litre</span> <a href="cart.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Order Now</a> </div>-->
															</div>
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2><i><u>Easy 3 Step Order</u></i></h2>
                    ...
                    <div class="row how-it-works-solution">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3><i>Pick Up or Delivery</i></h3>
                                <p><i>Get your choice! Design Your Home! Pay online On pickup or delivery</i></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info"><i>Pay by Cash On delivery</i></p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4><b><u>Featured products</u></b></h4> </div>
                    </div>
                    <div class="col-sm-8">-->
                        <!-- products filter nav starts -->
                      <!--  <div class="products-filter pull-right">
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <h5><i><u>About Us</u></i></h5>
                            <i><h5>Address :- </h5>
                            <p>Saliya Road,<br>Colpetty<br>Colombo-7 </p>
