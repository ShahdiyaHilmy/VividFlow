...
<html lang="en">
<?php
   include "css/password_validater.css";
...
if(isset($_POST['submit'] )) //if submit btn is pressed
{
	...
	elseif(strlen($_POST['password']) < 8)  //cal password length
	{
		$message = "Password Must be over 8 characters";
	}
	elseif(strlen($_POST['phone']) < 10  ||   strlen($_POST['phone']) > 10  )  //cal phone length
	{
                                 ...
                                 <div class="row">
								  <div class="form-group col-sm-12">
                                    ...
                                    <div class="form-group col-sm-6">
                                       ...
                                       <input type="text" class="form-control" name="email" id="exampleInputEmail1" aria-describedby="emailHelp" > <small id="emailHelp" class="form-text text-muted"><i>We"ll never share your email with anyone else.</i></small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Phone Number</label>
                                       <input class="form-control" type="text" name="phone" id="example-tel-input-3" placeholder="Phone"> <small class="form-text text-muted"><i>We"ll never share your phone no. with anyone else.</i></small> 
                                    </div>
                                    <div class="form-group col-sm-6">
                                    ...
                                    <div class="custom-control custom-checkbox mb-12">
                                          <input type="checkbox" class="custom-control-input" id ="showPw" onclick="myFunction()">
                                          <label for="showPw" class="h6" >Click Here To Show Password</label>
                                    
                                    </div>

                                    <div class="form-group col-sm-12">
                                       <div id="message" >
                                             <p class="mb-0" id="letter" class="invalid">A <b>lowercase</b> letter</p>
                                             <p class="mb-0" id="capital" class="invalid">A <b>capital (uppercase)</b> letter</p>
                                             <p class="mb-0" id="number" class="invalid">A <b>number</b></p>
                                             <p class="mb-0" id="length" class="invalid">Minimum <b>8 characters</b></p>
                                       </div>
                                    </div>
