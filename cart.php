...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="products.php">Choose Color</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="cart.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite color</a></li>
			...
			<?php $ress= mysqli_query($db,"select * from products where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/home.webp">
                <div class="profile">
                    <div class="container">
                        <div class="row">
                            <!-- <div class="col-xs-12 col-sm-12  col-md-4 col-lg-4 profile-img">
                                <div class="image-wrap">
                                    <figure><?php echo '<img src="admin/Res_img/colors/'.$rows['image'].'" alt="Food logo">'; ?></figure>
                                </div>
                            </div> -->
...
?>									
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              New Look for Your New World! <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
						...
						<?php  // display values and item of colors
									$stmt = $db->prepare("select * from colors where rs_id='$_GET[res_id]'");
									$stmt->execute();
                                    ...
                                    <div class="row">
										...
										<form method="post" action='cart.php?res_id=<?php echo $_GET['res_id'];?>&action=add&id=<?php echo $product['d_id']; ?>'>
                                            <div class="rest-logo pull-left">
                                                <a class="restaurant-logo pull-left" href="#"><?php echo '<img src="admin/Res_img/colors/'.$product['img'].'" alt="Food logo">'; ?></a>
                                            </div>
                                            <!-- end:Logo -->
                                            <div class="rest-descr">
                                                <h6><a href="#"><?php echo $product['title']; ?></a></h6>
                                                <p> <?php echo $product['price']; ?> / 1 Litre</p>
                                            </div>
                                            <!-- end:Description -->
                                        </div>
                                        <!-- end:col -->
