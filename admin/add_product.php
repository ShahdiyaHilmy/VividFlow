            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        <!-- Logo icon -->
                        <b><img src="images/logo.png" alt="dashboard.php" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                                        ...
                                        <div class="row p-t-20">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group has-danger">
                                                    ...
                                                    <input type="text" name="qty" class="form-control form-control-danger" placeholder="qty">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                        </div>
