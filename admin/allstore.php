            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        <!-- Logo icon -->
                        <b><img src="images/paint-shop.png" alt="home" class="dark-logo" /></b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span><img src="images/logo-text.png" alt="home" class="dark-logo" /></span>
                    </a>
                </div>
                <!-- End Logo -->
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                       ...
                                       <!-- <tfoot>
                                        ...
                                        <tbody>
                                               	...
                                               	<?php
												$sql="SELECT * FROM products order by rs_id desc";
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$mql="SELECT * FROM products where rs_id='".$rows['rs_id']."'";
                                                                                    ...
                                                                                    <!--<td>'.$row['c_name'].'</td>-->
																								...
																								<center><img src="Res_img/colors/'.$rows['image'].'" class="img-responsive radius"  style="min-width:150px;min-height:100px;"/></center>
																								</div></td>
